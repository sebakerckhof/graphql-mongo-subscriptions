// Adapted from : https://github.com/meteor/meteor/blob/devel/packages/minimongo
...
// https://github.com/meteor/meteor/blob/devel/packages/minimongo/helpers.js
...
const isPlainObject = LocalCollection._isPlainObject = function (x) {
  return x && LocalCollection._f._type(x) === 3;
};

const isIndexable = function (x) {
...
// others don't.
const isOperatorObject = function (valueSelector, inconsistentOK) {
...
//  - a "matcher" is its compiled form (whether a full Matcher
...
module.exports = Minimongo.Matcher;